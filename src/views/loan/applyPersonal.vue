<template>
  <div class="page-wrapper limit-width">
    <div class="loan-header-sec">
      <el-button type="primary" @click="handleBack">返回列表</el-button>
    </div>
    <div class="loan-personal-wrapper">
      <div class="title">个人创业担保贷款申请</div>
      ...
      <div class="footer-section">
        <el-button @click="handleValidate" type="primary" :loading="loading">提交</el-button>
      </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    // 资料证明文件上传成功
    handleMaterial(res: Record<string, unknown>, file: FileType) {
